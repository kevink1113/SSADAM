    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mil_address', models.CharField(blank=True, max_length=100, null=True)),
                ('homepage', models.URLField(blank=True, null=True)),
                ('github_id', models.CharField(blank=True, max_length=30, null=True)),
                ('blog', models.URLField(blank=True, null=True)),
                ('boj_id', models.CharField(blank=True, max_length=30, null=True)),
